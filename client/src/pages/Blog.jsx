...
const Blog = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 bg-gradient-to-br from-indigo-900 to-purple-800 min-h-screen">
      {/* Create Post Card */}
      <AnimatePresence>
        {user && (
          <motion.div
                  ...
                  >
                    <motion.span
                      animate={{
                        ...
                        color: blog.likes?.some(like => like.userId === user?._id) ? "#db2777" : "#6d28d9"
                      }}
