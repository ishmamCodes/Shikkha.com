...
router.get('/educators', authMiddleware, authorizeRole(["admin"]), listEducators);
router.patch('/educators/:id/suspend', authMiddleware, authorizeRole(["admin"]), suspendEducator);
router.patch('/educators/:id/activate', authMiddleware, authorizeRole(["admin"]), activateEducator);
router.delete('/educators/:id', authMiddleware, authorizeRole(["admin"]), deleteEducator);
